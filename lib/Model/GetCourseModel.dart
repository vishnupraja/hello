...
/// url : "https://alphawizztest.tk/newlearning/api/uploads/"
...
class GetCourseModel {
  ...
  GetCourseModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  List<Data>? _data;
  String? _url;
GetCourseModel copyWith({  bool? status,
  String? message,
  List<Data>? data,
  String? url,
}) => GetCourseModel(  status: status ?? _status,
