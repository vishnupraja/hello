...
GetSingleQuizModel getSingleQuizModelFromJson(String str) => GetSingleQuizModel.fromJson(json.decode(str));
String getSingleQuizModelToJson(GetSingleQuizModel data) => json.encode(data.toJson());
class GetSingleQuizModel {
  GetSingleQuizModel({
      bool? status, 
      String? message, 
      List<Data>? data,}){
  ...
  GetSingleQuizModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  String? _message;
  List<Data>? _data;
GetSingleQuizModel copyWith({  bool? status,
  String? message,
  List<Data>? data,
}) => GetSingleQuizModel(  status: status ?? _status,
